...
class verificador:
    ...
    def verificar_stock(self):
        for producto in self.productos:
            print(f"Verificando stock del producto {producto.marca}...")
            if producto.verificar_stock():
                print(f"El producto {producto.marca} está disponible.")
            else:
    ...
    def metodo_pago(self, metodo, saldo):
        ...
        print(f"El método de pago es {self.metodo.obtener_metodo()} y su saldo disponibles es de {self.metodo.obtener_saldo()} pesos.")
...
metodo_pago1 = Metodo_pago("Tarjeta de crédito y efectivo", 500)
